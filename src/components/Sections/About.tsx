...
const About: FC = memo(() => {
  ...
  return (
    <Section className="bg-neutral-800" sectionId={SectionId.About}>
      <div ref={ref} className={classNames('grid grid-cols-1 gap-y-4 transition-all duration-700 ease-out', {'md:grid-cols-4': !!profileImageSrc}, isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10')}>
        {!!profileImageSrc && (
